...
class NewsletterAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ('À la une', {'fields': [
         'titre_dossier', 'photo_dossier', 'texte_dossier', 'lien_dossier'], 'classes': ['wide']}),
        ('Bloc appels d\'offres', {'fields': ['appel'], 'classes': ['wide']}),
        ('Bloc actualités', {
         'fields': ['actualite', 'evenement', 'publication'], 'classes': ['wide']}),
        ('Liens utils', {
         'fields': ['lien', 'lien2', 'lienFace'], 'classes': ['collapse']}),
        ('Information du footer', {
         'fields': ['footer', 'abonne'], 'classes': ['collapse']}),
    ]
...
class FilAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ('Contenu principal', {
         'fields': ['actualite', 'evenement'], 'classes': ['wide']}),
        ('Information du footer', {
         'fields': ['footer'], 'classes': ['collapse']}),
    ]
...
class BreveAdmin(admin.ModelAdmin):
    ...
    adminfiles_fields = ('texte_intro', 'texte_rh', 'texte_ari',
                         'texte_agenda', 'texte_mission', 'texte_arrive')

    fieldsets = [
        ('Informations', {'fields': ['numero', 'date']}),
        ('Texte introduction', {
         'fields': ['texte_intro'], 'classes': ['wide']}),
        ('Texte RH', {'fields': ['texte_rh'], 'classes': ['wide']}),
        ('Texte ARI', {'fields': ['texte_ari'], 'classes': ['wide']}),
        ('Texte agenda recteur', {
         'fields': ['texte_agenda'], 'classes': ['wide']}),
        ('Texte prochainement en mission', {
         'fields': ['texte_mission'], 'classes': ['wide']}),
        ('Texte arrivés-départs',
         {'fields': ['texte_arrive'], 'classes': ['wide']}),
        ('Texte divers', {'fields': ['texte_diver'], 'classes': ['wide']}),
        ('Texte autres infos', {
         'fields': ['texte_autre'], 'classes': ['wide']}),
        ('Texte pied de page', {
         'fields': ['footer'], 'classes': ['collapse']}),
    ]
...
class PlaneteAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ('Dossier du mois', {'fields': [
         'titre_dossier', 'photo_dossier', 'texte_dossier', 'lien_dossier'], 'classes': ['wide']}),
        ('Agenda et appels d\'offres', {'fields': [
         'evenement_planete', 'appel_planete', 'bourse_planete'], 'classes': ['wide']}),
...
class AbonneAdmin(admin.ModelAdmin):
    ...
    def exporter(self, request, queryset):
        ...
        response[
            'Content-Disposition'] = 'attachment; filename="Abonnes_newsletter.csv"'
