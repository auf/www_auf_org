...
class Migration(SchemaMigration):
    ...
    models = {
        'carte.coordonneesimplantations': {
            'Meta': {'object_name': 'CoordonneesImplantations'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'implantation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['references.Implantation']"}),
            'latitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '4'}),
            'longitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '4'}),
        ...
        'references.implantation': {
            ...
            'bureau_rattachement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['references.Implantation']", 'null': 'True', 'db_column': "'bureau_rattachement'", 'blank': 'True'}),
